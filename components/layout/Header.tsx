...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-green-deep/10 bg-ivory/92 backdrop-blur">
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 sm:px-6 lg:px-8">
        ...
        <div className="hidden items-center gap-3 lg:flex">
          ...
          <Link
            ...
            target="_blank"
            rel="noreferrer"
            className="focus-ring rounded-xl px-3 py-2 text-sm font-semibold text-green-deep hover:bg-white"
          >
            Právne služby
          </Link>
